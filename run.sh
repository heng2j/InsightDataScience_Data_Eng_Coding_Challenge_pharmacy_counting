...
# time tail +2 ./input/de_cc_data.txt | python3 ./src/mapper.py | sort | python3 ./src/reducer.py | sort -t $'\t' -k 3nr -k 1,1  | python3 ./src/saveutput.py -o ./output/top_cost_drug_large_mapreduce.txt
# echo "Done"
